...
WickContractionSpaceVerticesMOD[V[A_] *B_, OptionsPattern[]]:=Block[{locFields={}, starFields={}, deltaFields={},deltaStarFields={},contributions=0,z,zTemp1,zTemp2,\[Kappa],jj,l,timeIndex,ii},
...
While[!FreeQ[z,starFields[[l]][___,Subscript[t, timeIndex]]]&& ii<OptionValue["maxContractions"],
...
centerCoord=Solve[{(px-cx)^2+(py-cy)^2==r^2,(qx-cx)^2+(qy-cy)^2==r^2}/.sub,{cx,cy},Assumptions->r>0];
