...
terms=exp//.F_[A___,Subscript[x, a_],B___]Subscript[G, \[Psi]][Subscript[x, a_],Subscript[x, b_],Subscript[t, c_]]:>F[A,Subscript[x, b],B]Subscript[G, \[Psi]][Subscript[x, a],Subscript[x, b],Subscript[t, c]]/.Subscript[G, \[Psi]][Subscript[x, a_],Subscript[x, b_],Subscript[t, c_]]:>Subscript[G, \[Psi]][Subscript[x, b],Subscript[x, b],Subscript[t, c]];
terms=List @@ (terms);

pureProp=Delete[terms,1];
pureProp=DeleteElements[pureProp,{g,\[Gamma]1,\[Gamma]2,\[Gamma]1g,\[Gamma]2g}];
...
Options[ToMomentumSpace]={"print"->False,"m\[Chi]"->m2\[Chi],"m\[Phi]"->m2\[Phi],"amputateLegs"->{\[Chi]s}};
...
momentumExp=momentumExp//.\[Delta][a_,A___]\[Delta][ Subscript[p, b_],A___]:>\[Delta][a+ Subscript[p, b],A]//.\[Delta][a_,A___]\[Delta][- Subscript[p, b_],A___]:>\[Delta][a- Subscript[p, b],A]/.\[Delta][a_+Subscript[p, b_],A___]:>DiracDelta[a+ Subscript[p, b]]\[DifferentialD]Subscript[p, b];
...
momentumExp=momentumExp/.OptionValue["amputateLegs"][[i]][a_+Subscript[p, b_]]:>OptionValue["amputateLegs"][[i]][a+Subscript[p, b]]WannaBeDiracDelta[a+Subscript[p, b]]\[DifferentialD]Subscript[p, b]/.OptionValue["amputateLegs"][[i]][a_-Subscript[p, b_]]:>OptionValue["amputateLegs"][[i]][a-Subscript[p, b]]WannaBeDiracDelta[a-Subscript[p, b]]\[DifferentialD]Subscript[p, b]/.OptionValue["amputateLegs"][[i]][Subscript[p, b_]]:>OptionValue["amputateLegs"][[i]][Subscript[p, b]]WannaBeDiracDelta[Subscript[p, b]]\[DifferentialD]Subscript[p, b];
];
...
momentumExp=momentumExp/.WannaBeDiracDelta[a_+c_ Subscript[p, b_]+d_ Subscript[p, e_]](\[DifferentialD]Subscript[p, b_])^2:> WannaBeDiracDelta[a+c Subscript[p, b]+d Subscript[p, e]]\[DifferentialD]Subscript[p, e] \[DifferentialD]Subscript[p, b]/.WannaBeDiracDelta[c_ Subscript[p, b_]+d_ Subscript[p, e_]](\[DifferentialD]Subscript[p, b_])^2:> WannaBeDiracDelta[c Subscript[p, b]+d Subscript[p, e]]\[DifferentialD]Subscript[p, e] \[DifferentialD]Subscript[p, b];
