...
g=myFavoriteGraph;
endTime=1;
Z=FinalDynamicLERWaction["graph"->g,"endTime"->endTime]/.\[Beta][__]->1;
Z0=Z/.\[Gamma]->0;


(* ::Input::Initialization:: *)
\[Phi]s[1,Subscript[t, 1],Subscript[k, 1]]/Znorm[\[Phi]s[1,Subscript[t, 1],Subscript[k, 1]],"graph"->g,"\[Beta]rule"->{\[Beta][__]->1}];

expLERWbenchmark =ExpectationValueBlock[Z %,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.Subscript[t, a_]->Subscript[t, a-1]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)"//Expand;


(* ::Input::Initialization:: *)
Replace[expLERWbenchmark,a_/;(!NumericQ[a]):>a/(Znorm[a,"graph"->g,"\[Beta]rule"->{\[Beta][__]->1}]),1];

expLERWbenchmark2=ExpectationValueBlock[Z %,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.Subscript[t, a_]->Subscript[t, a-1]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)"//Expand;


(* ::Input::Initialization:: *)
Replace[expLERWbenchmark2,a_/;(!NumericQ[a]):>a/(Znorm[a,"graph"->g,"\[Beta]rule"->{\[Beta][__]->1}]),1];

expLERWbenchmark3=ExpectationValueBlock[Z %,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.Subscript[t, a_]->Subscript[t, a-1]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(3\)]\)"//Expand;
...
actionTimeSlice [T_]:= Product[
If[totWeights[[x]]===0  || MemberQ[OptionValue["excludedVertices"],x],1,
(*FALSE*)V[(1+\[Gamma] Sum[locWeights[[x,y]]((R[x,y,Red]\[Phi]s[y,Subscript[t, T+1],Subscript[k, y]]\[Chi]s[y,Subscript[t, T],1]-\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]\[Chi]s[x,Subscript[t, T],1])\[Psi]s[x,Subscript[t, T+1],Subscript[ll, x]]-\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]](\[Chi]s[y,Subscript[t, T],1]-\[Chi]s[x,Subscript[t, T],1])),{y,Length[locVertices]}]*\[Phi][x,Subscript[t, T],Subscript[k, x]]
+Sum[locWeights[[x,y]]/totWeights[[x]] R[x,y,Blue]\[Chi]s[y,Subscript[t, T],Subscript[i, x]],{y,Length[locVertices]}]*\[Chi][x,Subscript[t, T],Subscript[i, x]]
+(*COPY \[Psi]*) \[Psi]s[x,Subscript[t, T+1],Subscript[ll, x]]*\[Psi][x,Subscript[t, T],Subscript[ll, x]]) ]
V[(1+(*COPY \[Phi]*) \[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]*\[Phi][x,Subscript[t, T],Subscript[k, x]])](*I AM SEPARATING \[Phi] and \[Psi]!*)
],{x,Length[locVertices]}]
V[(1+ \[Phi]s[locSource,Subscript[t, T+1],Subscript[k, locSource]]\[Phi][locSource,Subscript[t, T],Subscript[k, locSource]]+\[Chi][locSource,Subscript[t, T],1])];
...
g=myFavoriteGraph;
endTime=1;
Z=LRWactionREALinteraction["graph"->g,"endTime"->endTime]/.\[Beta][__]->1;


(* ::Input::Initialization:: *)
\[Phi]s[1,Subscript[t, 1],Subscript[k, 1]]/Znorm[\[Phi]s[1,Subscript[t, 1],Subscript[k, 1]],"graph"->g,"\[Beta]rule"->{\[Beta][__]->1},"fieldsToExclude"->{\[Psi]s}];

expLERWrealInteraction=ExpectationValueBlock[Z %,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.Subscript[t, a_]->Subscript[t, a-1]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)"//Expand


(* ::Input::Initialization:: *)
Replace[expLERWrealInteraction,a_/;(!NumericQ[a]):>a/(Znorm[a,"graph"->g,"\[Beta]rule"->{\[Beta][__]->1},"fieldsToExclude"->{\[Psi]s}]),1];

expLERWrealInteraction2=ExpectationValueBlock[Z % ,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.Subscript[t, a_]->Subscript[t, a-1]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)"//Expand
...
(* ::Input::Initialization:: *)
Clear[DLAactionBenchmark];
Options[DLAactionBenchmark]={"sourceBC"->1,"excludedVertices"->{},"graph"->g,"endTime"->10};

DLAactionBenchmark[OptionsPattern[]]:=Module[{locGraph,locEndTime,locSource,locRoot,locWeights,totWeights,locVertices,actionTimeSlice,action},
Clear[i,k,j,\[Gamma]];
...
Sum[locWeights[[x,y]]/(1*totWeights[[x]]) R[x,y,Blue]\[Chi]s[y,Subscript[t, T],Subscript[i, x]]\[Chi][x,Subscript[t, T],Subscript[i, x]],{y,Length[locVertices]}]+\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]\[Phi][x,Subscript[t, T],Subscript[k, x]]) ]
],{x,Length[locVertices]}]
...
g=myFavoriteGraph;
endTime=1;
Z=DLAactionBenchmark["graph"->g,"endTime"->endTime]/.\[Beta][__]->1;


(* ::Input::Initialization:: *)
\[Phi]s[1,Subscript[t, 1],Subscript[k, 1]]/Znorm[\[Phi]s[1,Subscript[t, 1],Subscript[k, 1]],"graph"->g,"\[Beta]rule"->{\[Beta][__]->1}(*,"fieldsToExclude"->{\[Psi]s}*)];

DLAbenchmark=ExpectationValueBlock[Z %,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.\[Phi]s[b_,Subscript[t, a_],c_]->\[Phi]s[b,Subscript[t, a-1],c]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(1\)]\)"//Expand


(* ::Input::Initialization:: *)
Replace[DLAbenchmark,a_/;(!NumericQ[a]):>a/(Znorm[a,"graph"->g,"\[Beta]rule"->{\[Beta][__]->1}(*,"fieldsToExclude"->{\[Psi]s}*)]),1];

DLAbenchmark2=ExpectationValueBlock[Z % ,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.\[Phi]s[b_,Subscript[t, a_],c_]->\[Phi]s[b,Subscript[t, a-1],c]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(2\)]\)"//Expand


(* ::Input::Initialization:: *)
Replace[DLAbenchmark2,a_/;(!NumericQ[a]):>a/(Znorm[a,"graph"->g,"\[Beta]rule"->{\[Beta][__]->1}(*,"fieldsToExclude"->{\[Psi]s}*)]),1];

DLAbenchmark3=ExpectationValueBlock[Z % ,"endTime"->endTime,"fields"->fields,"draw"->False,"Rrule"->{R[__,Blue]->1},"external\[Delta]"->True,"graph"->g]/.\[Phi]s[b_,Subscript[t, a_],c_]->\[Phi]s[b,Subscript[t, a-1],c]/.\[Gamma]->"\!\(\*SubscriptBox[\(\[Gamma]\), \(3\)]\)"//Expand


(* ::Input::Initialization:: *)
Clear[DLAactionExp\[Phi]];
Options[DLAactionExp\[Phi]]={"sourceBC"->1,"excludedVertices"->{},"graph"->g,"endTime"->10};

DLAactionExp\[Phi][OptionsPattern[]]:=Module[{locGraph,locEndTime,locSource,locRoot,locWeights,totWeights,locVertices,actionTimeSlice,action},
Clear[i,k,j,\[Gamma]];
...
If[totWeights[[x]]===0  || MemberQ[OptionValue["excludedVertices"],x],1,
(*FALSE*)V[((*1+*)\[Gamma] Sum[locWeights[[x,y]](R[x,y,Red]\[Phi]s[y,Subscript[t, T+1],Subscript[k, y]]-1)\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]\[Phi][x,Subscript[t, T],Subscript[k, x]]\[Chi]s[y,Subscript[t, T],1],{y,Length[locVertices]}]+
Sum[locWeights[[x,y]]/(1*totWeights[[x]]) R[x,y,Blue]\[Chi]s[y,Subscript[t, T],Subscript[i, x]]\[Chi][x,Subscript[t, T],Subscript[i, x]],{y,Length[locVertices]}]+Exp[\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]\[Phi][x,Subscript[t, T],Subscript[k, x]]]) ]
],{x,Length[locVertices]}]
V[(1+ \[Phi]s[locSource,Subscript[t, T+1],Subscript[k, locSource]]\[Phi][locSource,Subscript[t, T],Subscript[k, locSource]]+OptionValue["sourceBC"]\[Chi][locSource,Subscript[t, T],1])];
...
(* ::Input::Initialization:: *)
Clear[DLAactionExp\[Phi]No\[Gamma]1];
Options[DLAactionExp\[Phi]No\[Gamma]1]={"sourceBC"->1,"excludedVertices"->{},"graph"->g,"endTime"->10};

DLAactionExp\[Phi]No\[Gamma]1[OptionsPattern[]]:=Module[{locGraph,locEndTime,locSource,locRoot,locWeights,totWeights,locVertices,actionTimeSlice,action},
Clear[i,k,j,\[Gamma]];
...
actionTimeSlice [T_]:= Product[
If[totWeights[[x]]===0  || MemberQ[OptionValue["excludedVertices"],x],1,
(*FALSE*)V[(\[Gamma] Sum[locWeights[[x,y]]((R[x,y,Red]\[Phi]s[y,Subscript[t, T+1],Subscript[k, y]]\[Chi]s[y,Subscript[t, T],1]-\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]\[Chi]s[x,Subscript[t, T],1])\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]-\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]](\[Chi]s[y,Subscript[t, T],1]-\[Chi]s[x,Subscript[t, T],1]))\[Phi][x,Subscript[t, T],Subscript[k, x]],{y,Length[locVertices]}]+
Sum[locWeights[[x,y]]/(1*totWeights[[x]]) R[x,y,Blue]\[Chi]s[y,Subscript[t, T],Subscript[i, x]]\[Chi][x,Subscript[t, T],Subscript[i, x]],{y,Length[locVertices]}]+Exp[\[Phi]s[x,Subscript[t, T+1],Subscript[k, x]]\[Phi][x,Subscript[t, T],Subscript[k, x]]]) ]
],{x,Length[locVertices]}]
V[(1+ \[Phi]s[locSource,Subscript[t, T+1],Subscript[k, locSource]]\[Phi][locSource,Subscript[t, T],Subscript[k, locSource]]+OptionValue["sourceBC"]\[Chi][locSource,Subscript[t, T],1])];
