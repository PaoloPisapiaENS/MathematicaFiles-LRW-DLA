...
(**)
(*Show[{ListPlot[logAveragedWithMaxDev,PlotStyle->{GrayLevel[0],Directive[Opacity[0.3]]},AxesLabel->{"Log[L]","Log[N]"}]*)
(*,ListPlot[logAveragedWithErrors,PlotStyle->{RGBColor[0, 0.78, 1],PointSize->0.005},PlotLegends->{"logAveragedWithErrors"}]*)
...
(*,PlotLabel->Row[{" b = ",b}]*)
(*,PlotRange->{All,{0,10}}(*PlotRange->{{Log[thresholdBelow],Log[maxy]},{4,7.2}}*),AxesOrigin->{(*Log[thresholdBelow]*)1,0},ImageSize->700]*)
